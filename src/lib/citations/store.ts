...
export async function setCitationConfig(domain: string, queries: string[]): Promise<CitationConfig> {
  return mutateJson<CitationConfig, CitationConfig>(FILE, DEFAULT, (cur) => {
